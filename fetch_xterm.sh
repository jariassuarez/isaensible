...
curl -fsSL "${BASE}/xterm.js"          -o static/js/xterm.js
curl -fsSL "${CSS_BASE}/xterm.css"     -o static/css/xterm.css
curl -fsSL "${FIT_BASE}/xterm-addon-fit.js" -o static/js/xterm-addon-fit.js
echo "Done."
